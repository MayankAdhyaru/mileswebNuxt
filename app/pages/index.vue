...
import Hero from '~/components/newCommon/Hero.vue'
import Newrating from '~/components/newCommon/Newrating.vue'
import CaseStudy from '~/components/newCommon/CaseStudy.vue'
import Migration from '~/components/newCommon/Migration.vue'
import CustomerReviews from '~/components/newCommon/CustomerReviews.vue'
import ComparisonTbl from '~/components/newCommon/ComparisonTbl.vue'
import FaqSection from '~/components/newCommon/FaqSection.vue'
import ProductAndServices from '~/components/newCommon/ProductAndServices.vue'
import closingSection from '~/components/newCommon/ClosingSection.vue'
import Plans from '~/components/newCommon/Plans.vue'
