export default defineEventHandler(async () => {
    ...
    return [
        {
            pid: 1142,
            plan_ttl_img: "/assets/images/mw/economy.svg",
            plan_ttl_img_alt: "Great for first-time users.",
            title: common?.plansName?.web_1,
            subtitle: "Great for first-time users.",
            strike_price: common.strikePrice?.web_1?.[1],
            currency: common.currencySymbol,
            price: common.price?.web_1?.[1],
            save: `${common?.save.web_1?.[1]}`,
            ...
            features: [
                { label: '<b>1</b> website', tooltip: 'The number of websites that you can host in your web hosting account.' },
                { label: '<b>50</b> GB NVMe storage', tooltip: 'Our storage is based on modern solid-state drives. Your website will perform 200% better as compared to the regular drives with the specified storage amount.' },
                { label: 'Free domain', tooltip: `The '${common?.plansName?.web_1}' plan does not include a free domain. To get a free domain name, opt for the '${common?.plansName?.web_2}', '${common?.plansName?.web_3}', or '${common?.plansName?.cloud_1}' plan.`, cross: true },
                { label: '<b>2</b> mailboxes - Free', tooltip: 'Create up to 2 mailboxes with 1GB storage each—free and included in your hosting plan. No extra charges. Ideal for personal or business use.' },
                { label: '<b>Free SSL</b> for your website', tooltip: 'We secure all supported websites on your plan with free, automated SSL certificates. No validation email required, auto-renewed, and trusted by major browsers.' },
                ...
                { label: 'Website builder', tooltip: false, cross: true },
                ...
                { label: 'Website speed optimizer with CDN', tooltip: false, cross: true },
                { label: '24/7 Priority support', tooltip: false, cross: true },
            ...
            hidden_features: {
                "Managed WordPress": [
                    ...
                    { label: 'WooCommerce', tooltip: false, cross: true },
                ],
                'Developer\'s feature': [
                ...
                'Security': [
                    ...
                    { label: 'Anycast nameservers', tooltip: false, cross: true },
                    { label: 'Enhanced DDoS protection', tooltip: false, cross: true },
                ],
                'Service and support': [
                ...
                'Technical details': [
                    { label: '<b>3,00,000</b> files & directories (inodes)', tooltip: 'File inodes are the fundamental unit of a file system. In simple terms, it stores information about a file or directory that runs on your server.' },
                    { label: '<b>20</b> PHP workers', tooltip: 'PHP workers are similar to the engine handling website requests and page buildings. More PHP workers mean faster and more efficient tasks, leading to smoother browsing experiences.' },
                    { label: '<b>~10,000</b> visits monthly', tooltip: 'The monthly visit number represents the estimated amount of traffic your websites can manage. Select your hosting plan according to the total number of visitors you expect across all your websites. ' },
                    { label: '<b>2</b> subdomains', tooltip: 'This number indicates how many subdomains you can create not only from your primary domain but also from any additional domains. Moreover, subdomains can be directed to any subdirectory within your hosting account.' },
                    { label: '<b>25</b> MySQL max user connections', tooltip: 'Using this limit, know how many simultaneous database connections can be made for a seamless hosting experience.' },
                    { label: '<b>2</b> databases', tooltip: 'This specifies the maximum number of individual databases you can create and manage within a single hosting account, providing developers with ample flexibility and scalability for their database-driven applications.' },
                    { label: '<b>1</b> FTP account', tooltip: 'Keep track of visitors that are logged into your site via FTP. It also allows you to terminate FTP connections to restrict file access to unauthorized users.' },
                    { label: '<b>5</b> cronjobs', tooltip: 'Cronjobs helps you schedule the execution of commands or scripts on a server at fixed intervals, dates, or times. The more cron jobs by your side, the maximum number of tasks you can schedule simultaneously.' },
                    ...
                    { label: 'Powerful control panel', tooltip: 'We offer the best intuitive control panel with our hosting plans. It is specifically designed and developed to maximize the potential of your website, it\'s management, and the service we provide for you.' },
                    { label: '<b>756 MB</b> RAM', tooltip: 'The amount of memory offered with each hosting plan.' },
                    { label: '<b>1</b> CPU Core', tooltip: 'A CPU’s processor is called a CPU core. It is the number of CPU cores offered with our web hosting plans.' },
                    { label: '<b>6 MBPS</b> IO Limit', tooltip: 'Represents the disk input and output limit.' },
                ...
                'AI tools included': [
                    { label: 'AI image generator', tooltip: false, cross: true },
                    { label: 'AI writer', tooltip: false, cross: true },
                    { label: 'AI blog generator', tooltip: false, cross: true },
                ],
            }
        },
        {
            ...
            strike_price: common.strikePrice?.web_2?.[1],
            currency: common.currencySymbol,
            price: common.price?.web_2?.[1],
            save: `${common?.save.web_2?.[1]}`,
            buy_link: "https://www.milesweb.in/checkout",
            billingcycle: "quadrennially",
            free_months: "+3 months free",
            category: "Shared Hosting",
            HighestBilling: "4 Years",
            features: [
                ...
                { label: '<b>Free</b> domain for 1 year', tooltip: `Choose a ${common?.plansName?.web_2} plan for 1, 2, or 4 years and receive one complimentary domain (.COM, .IN, or .CO.IN) for the first year. Select any single extension; standard renewal rates apply from the second year. This offer cannot be customized.`, 'freeDomain': false },
                ...
                { label: 'Stay secure with daily backups', },
                { label: '<b>Free</b> website migration', tooltip: 'We provide a free migration service to help transfer your website from your previous provider to ours. We migrate your complete website files, folders, databases, and emails.' },
                { label: 'Website builder', tooltip: 'Create your professional website in minutes — no coding needed.' },
                { label: 'Managed WordPress hosting', tooltip: 'MilesWeb’s managed WordPress hosting provides a hands-free experience with tools like one-click staging, automatic updates, WP-CLI, Git, SSH, and PHP version control—perfect for hassle-free WordPress development and management.' },
                { label: 'Complete site protection', tooltip: 'Our malware scan tool scans your website for malware, quarantines the infected files, and cleans them automatically. It also generates a detailed report of the findings, ensuring your website remains safe and secure.' },
        ...
        },
        {
            ...
            title: common?.plansName?.web_3,
            subtitle: "Great for startups and agencies.",
            strike_price: common.strikePrice?.web_3?.[1],
            currency: common.currencySymbol,
            price: common.price?.web_3?.[1],
            save: `${common?.save.web_3?.[1]}`,
            buy_link: "https://www.milesweb.in/checkout",
            billingcycle: "quadrennially",
            free_months: "+3 months free",
            category: "Shared Hosting",
            ...
            features: [
                ...
                { label: '<b>Free</b> domain for 1 year', tooltip: `Choose a ${common?.plansName?.web_3} plan for 1, 2, or 4 years and receive one complimentary domain (.COM, .IN, or .CO.IN) for the first year. Select any single extension; standard renewal rates apply from the second year. This offer cannot be customized.`, 'freeDomain': false },
        ...
        {
            pid: 1145,
            plan_ttl_img: "/assets/images/mw/alpha.svg",
            plan_ttl_img_alt: "Great for startups and agencies",
            title: common?.plansName?.cloud_1,
            subtitle: "Great for startups and agencies.",
            strike_price: common.strikePrice?.cloud_1?.[1],
            currency: common.currencySymbol,
            price: common.price?.cloud_1?.[1],
            save: `${common?.save.cloud_1?.[1]}`,
            buy_link: "https://www.milesweb.in/checkout",
            billingcycle: "quadrennially",
            free_months: "+3 months free",
            category: "Shared Hosting",
            HighestBilling: "4 Years",
            features: [
                { label: '<b>100</b> websites', tooltip: 'The number of websites that you can host in your web hosting account.' },
                { label: '<b>250</b> GB NVMe storage', tooltip: 'Our storage is based on modern solid-state drives. Your website will perform 200% better as compared to the regular drives with the specified storage amount.' },
                { label: '<b>Free</b> domain for 1 year', tooltip: 'Choose a Cloud Startup plan for 1, 2, or 4 years and receive one complimentary domain (.COM, .IN, or .CO.IN) for the first year. Select any single extension; standard renewal rates apply from the second year. This offer cannot be customized.', 'freeDomain': false },
                { label: '<b>150</b> mailboxes - Free', tooltip: 'Create up to 150 mailboxes with 5GB storage each—free and included in your hosting plan. No extra charges. Ideal for personal or business use.' },
                { label: '<b>Free SSL</b> for every website', tooltip: 'We secure all supported websites on your plan with free, automated SSL certificates. No validation email required, auto-renewed, and trusted by major browsers.' },
                { label: 'Stay secure with daily backups', },
                { label: '<b>Free</b> website migration', tooltip: 'We provide a free migration service to help transfer your website from your previous provider to ours. We migrate your complete website files, folders, databases, and emails.' },
            ...
            hidden_features: {
                "Managed WordPress": [
                    ...
                    { label: 'WP-CLI and SSH', tooltip: 'It is a set of command-line tools to manage the WordPress installation. It can be used for configuring multisite installs, updating plugins, and more without the help of a web browser.' },
                    { label: 'Object cache for WordPress', tooltip: 'Object caching is a method of saving database query results. Thus, the server swiftly retrieves them when needed again, improving WordPress website response times.' },
                    { label: 'Standard WooCommerce', tooltip: 'Ideal for growing e-store needs. Easily manage your growing business requirements with seamless product listings, page handling, invoices, and other standard features.' },
                ],
                'Developer\'s feature': [
                    { label: 'PHP', tooltip: 'Get PHP scripting language versions installed on our servers. You can select the PHP version (4.4 to 8.3) from your control panel.' },
                    { label: 'CodeIgniter', tooltip: false },
                    { label: 'Laravel', tooltip: false },
                    { label: 'Node.js', tooltip: 'Nodejs is an open-source, run-time environment that helps in executing javascript applications on a server side. You can select the versions (6.17 to  22.9) from your control panel.' },
                    { label: 'Python', tooltip: 'Python is a scripting language for your server requirements. You can select the Python version (2.7 to 3.12) from your control panel.' },
                    { label: 'Django', tooltip: 'It is a free and open-source web application framework written in Python that helps in rapidly developing safe and pragmatic websites. You can select the latest versions from your control panel.' },
                    { label: 'GIT access', tooltip: 'Easily manage, clone, view, and deploy Git repositories within your control panel. Git integration enables efficient project management, editing, and syncing across multiple branches using the powerful version control capabilities of Git.' },
                ],
                'Security': [
                    { label: 'Web application firewall', tooltip: 'Secures your website from malicious attacks such as Cross-site Scripting (XSS), SQL injection, Local File Include, XML-RPC DDOS Attack, Remote File Include, etc.' },
                ...
                'Technical details': [
                    { label: '<b>30,00,000</b> files & directories (inodes)', tooltip: 'File inodes are the fundamental unit of a file system. In simple terms, it stores information about a file or directory that runs on your server.' },
                    { label: '<b>100</b> PHP workers', tooltip: 'PHP workers are similar to the engine handling website requests and page buildings. More PHP workers mean faster and more efficient tasks, leading to smoother browsing experiences.' },
                    { label: '<b>~2,25,000</b> visits monthly', tooltip: 'The monthly visit number represents the estimated amount of traffic your websites can manage. Select your hosting plan according to the total number of visitors you expect across all your websites. ' },
                    { label: '<b>Unlimited</b> subdomains', tooltip: 'This number indicates how many subdomains you can create not only from your primary domain but also from any additional domains. Moreover, subdomains can be directed to any subdirectory within your hosting account.' },
                    { label: '<b>125</b> MySQL max user connections', tooltip: 'Using this limit, know how many simultaneous database connections can be made for a seamless hosting experience.' },
                    { label: '<b>Unlimited</b> databases', tooltip: 'This specifies the maximum number of individual databases you can create and manage within a single hosting account, providing developers with ample flexibility and scalability for their database-driven applications.' },
                    { label: '<b>Unlimited</b> FTP accounts', tooltip: 'Keep track of visitors that are logged into your site via FTP. It also allows you to terminate FTP connections to restrict file access to unauthorized users.' },
                    { label: '<b>Unlimited</b> cronjobs', tooltip: 'Cronjobs helps you schedule the execution of commands or scripts on a server at fixed intervals, dates, or times. The more cron jobs by your side, the maximum number of tasks you can schedule simultaneously.' },
                    { label: 'Multiple PHP versions', tooltip: 'Get PHP scripting language versions installed on our servers. You can select the PHP version (4.4 to 8.3) from your control panel.' },
                    { label: 'SSH access', tooltip: 'SSH offers secure, encrypted access to your hosting account, allowing safe file transfers, database handling, and SFTP functionality. It’s ideal for developers needing direct and protected server-level access for advanced operations.' },
                    { label: 'DNS management', tooltip: 'Create and edit all types of DNS records, including CNAME, A, TXT, MX, and SRV for your domains as well as subdomains.' },
                    { label: 'Cache manager', tooltip: 'Easily store copies of your files in a cache or temporary storage location so that they can be accessed more quickly.' },
                    { label: '<b>cPanel</b> control panel', tooltip: 'A user-friendly control panel to manage your websites, emails, and databases with ease.' },
                    { label: '<b>4 GB</b> RAM', tooltip: 'The amount of memory offered with each hosting plan.' },
                    { label: '<b>2</b> CPU Cores', tooltip: 'A CPU’s processor is called a CPU core. It is the number of CPU cores offered with our web hosting plans.' },
                    { label: '<b>20 MBPS</b> IO Limit', tooltip: 'Represents the disk input and output limit.' },
                    { label: 'Unmetered bandwidth', tooltip: 'Get an unrestricted amount of data transferred between the visitors and your website. We provide unlimited data transfer for you to host all types of websites and grow independently to gain more visitors.' },
                ],
